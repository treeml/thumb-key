...
fun buildShiftExport(
    ...
    val bedOf = { text: String -> beds.firstOrNull { it.label.trim().equals(text.trim(), true) } }
    ...
    return buildString {
        ...
        keys.forEach { key ->
            ...
            if (theirJobs.isEmpty() && theirReviews.isEmpty() && theirRounds.isEmpty()) return@forEach
